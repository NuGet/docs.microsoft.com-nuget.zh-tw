...
| [套件管理器主控台](consume-packages/install-use-packages-powershell.md) | Windows 上的 Visual Studio | 耗用量 | 提供 [PowerShell 命令](reference/Powershell-Reference.md)，以在 Visual Studio 專案中安裝和管理套件。 |
