...
## <a name="pre-requisites"></a><span data-ttu-id="6fca9-114">必要條件</span><span class="sxs-lookup"><span data-stu-id="6fca9-114">Pre-requisites</span></span>
