...
## <a name="pre-requisites"></a><span data-ttu-id="baadf-114">必要條件</span><span class="sxs-lookup"><span data-stu-id="baadf-114">Pre-requisites</span></span>
