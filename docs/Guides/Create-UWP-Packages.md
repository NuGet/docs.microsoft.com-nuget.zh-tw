...
1. [建立 UWP Windows 執行階段元件](#create-a-uwp-windows-runtime-component)
...
1. Visual Studio 2017 或 Visual Studio 2015. 從 [visualstudio.com](https://www.visualstudio.com/) 免費安裝 Community Edition，也可以使用 Professional Edition 和 Enterprise Edition。
