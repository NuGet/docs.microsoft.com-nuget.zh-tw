...
此外，如果您想在 Visual Studio 2015 和更早版本中使用 NuGet 套件管理員，請查看 [工具] > [擴充功能和更新]****，然後搜尋 NuGet 套件管理員擴充功能。 如果無法在 Visual Studio 中使用擴展安裝程式,則[https://dist.nuget.org/index.html](https://dist.nuget.org/index.html)可以直接從下載擴展。
...
要讓[`nuget.exe`CLI](../reference/nuget-exe-cli-reference.md)在套件管理員控制台中可用,請從主控台安裝[NuGet.CommandLine](https://www.nuget.org/packages/NuGet.CommandLine/)套件:
