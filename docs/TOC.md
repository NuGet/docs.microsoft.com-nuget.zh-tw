...
## [建立及發行 NET Standard 套件 (dotnet CLI)](quickstart/create-and-publish-a-package-using-the-dotnet-cli.md)
## [建立及發行 NET Standard 套件 (Visual Studio)](quickstart/create-and-publish-a-package-using-visual-studio.md)
...
# 裝載套件
## [總覽](hosting-packages/overview.md)
...
## [目標 Framework](reference/target-frameworks.md)
...
## [如何：查詢使用 API 的所有套件](guides/api/query-for-all-published-packages.md)
