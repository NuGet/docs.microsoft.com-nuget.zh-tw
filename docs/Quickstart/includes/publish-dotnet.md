1. <span data-ttu-id="b126d-101">變更為包含 `.nupkg` 檔案的資料夾。</span><span class="sxs-lookup"><span data-stu-id="b126d-101">Change to the folder containing the `.nupkg` file.</span></span>
