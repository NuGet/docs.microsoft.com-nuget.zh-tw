...
* 先解除安裝較舊組建。 您需要執行這項操作的系統管理員身分執行 VS。
* 移除您所擁有的所有現有摘要。
...
* 切換至 OData 服務端點從 ATOM 摘要的封裝： 如果您升級到 CTP2 版本的 NuGet，請務必新增為套件來源的下列 URL: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820)。
