...
---
# <a name="44-rtm-release-notes"></a>4.4 RTM 版本資訊
...
* dotnet add package 可以清除 csproj 中的空行  - [#5697](https://github.com/NuGet/Home/issues/5697)
...
* dotnet pack 的行為會根據 TargetFramework 與 TargetFrameworks 而不同 - [#5281](https://github.com/NuGet/Home/issues/5281)
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>4.4 RTM 中已修正 GitHub 問題的連結
